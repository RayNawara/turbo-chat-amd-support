...
class AiChat < ApplicationRecord
  ...
  SUPPORTED_AI_MODELS = {
    text: %w[mistral:7b-instruct-v0.3-q8_0 mixtral:8x7b-instruct-v0.1-q5_K_M codellama:7b-instruct codellama:34b-instruct phind-codellama:34b-v2 starcoder2:15b
