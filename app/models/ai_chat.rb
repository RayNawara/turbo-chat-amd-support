...
class AiChat < ApplicationRecord
  ...
  SUPPORTED_AI_MODELS = {
    text: %w[phi3:mini mistral:7b-instruct-v0.3-q8_0 mixtral:8x7b-instruct-v0.1-q5_K_M codellama:7b-instruct codellama:34b-instruct phind-codellama:34b-v2 starcoder2:15b
 dolphin-llama3:8b llama3.1:latest jean-luc/big-tiger-gemma:27b-v1c-Q3_K_M vanilj/mistral-nemo-12b-celeste-v1.9:Q4_K_M qwen2.5-coder gemma2],
